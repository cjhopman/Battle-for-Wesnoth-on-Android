/* $Id: play_controller.cpp 49335 2011-04-30 11:28:30Z boucman $ */
/*
...
void play_controller::preferences(bool use_classic){
	menu_handler_.preferences(use_classic);
}
...
void play_controller::undo(){
	map_location selected = mouse_handler_.get_selected_hex();
	if (selected.valid()) {
