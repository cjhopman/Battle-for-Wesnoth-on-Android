/* $Id: config.cpp 48450 2011-02-08 20:55:18Z mordante $ */
/*
...
#ifndef NDEBUG
		if (cfg != this) cfg->check_valid();
#endif

		foreach(const child_map::value_type& l, children)
			std::copy(l.second.begin(), l.second.end(), std::back_inserter(q));

		cfg->children.clear();
		if (cfg != this) delete cfg;
	}
