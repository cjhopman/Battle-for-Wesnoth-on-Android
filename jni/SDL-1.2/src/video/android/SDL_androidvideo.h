...
extern void SDL_ANDROID_TextInputFinished(int k);
...
extern void SDL_ANDROID_CallJavaShowScreenKeyboard(const char * oldText, char * outBuf, int outBufLen, int x, int y, int w, int h, int hide);
