/* $Id: scrollbar_container.cpp 49411 2011-05-07 15:11:50Z soliton $ */
/*
...
void tscrollbar_container::finalize_setup()
{
	...
	/***** Setup the touch linker *****/
	touch_.init(this, vertical_scrollbar_, horizontal_scrollbar_);
	touch_.set_enabled(vertical_scrollbar_mode_ != always_invisible || horizontal_scrollbar_mode_ != always_invisible);
}
