/* $Id: settings.cpp 49342 2011-05-02 18:52:36Z crab $ */
/*
...
static void fill_window_types()
{
	...
	window_type_list[TOUCH_GAME_MENU] = "touch_game_menu";
	window_type_list[PREFERENCES] = "preferences";
	window_type_list[UNIT_ATTACK] = "unit_attack";
	window_type_list[UNIT_ADVANCE] = "unit_advance";
	window_type_list[UNIT_LIST] = "unit_list";
	window_type_list[UNIT_RECRUIT] = "unit_recruit";
	window_type_list[UNIT_RECALL] = "unit_recall";
}
