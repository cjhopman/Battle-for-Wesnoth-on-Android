/* $Id: hotkeys.cpp 48450 2011-02-08 20:55:18Z mordante $ */
/*
...
#endif
	{ hotkey::HOTKEY_MENU, "menu", N_("Menu"), false, hotkey::SCOPE_GAME },
...
void key_event(display& disp, const SDL_KeyboardEvent& event, command_executor* executor)
{
	...
	if(get_hotkey(event).get_id() == HOTKEY_MENU && disp.in_game()) {
		LOG_G << "menu pressed...showing menu\n";
