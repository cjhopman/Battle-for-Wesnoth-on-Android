/* $Id: button.cpp 48450 2011-02-08 20:55:18Z mordante $ */
/*
...
const int horizontal_padding = font::SIZE_PLUS;
const int checkbox_horizontal_padding = font::SIZE_PLUS / 2;
const int vertical_padding = font::SIZE_PLUS / 2;
