...
ZIP=/tmp/pango-1.28.3.zip
DEVZIP=/tmp/pango-dev-1.28.3.zip
cd /home/chris/android-9

mkdir -p share/doc/pango-1.28.3
cp -p /home/chris/lib-src/pango-1.28.3/COPYING share/doc/pango-1.28.3

mkdir -p share/doc/pango-dev-1.28.3
cp -p /home/chris/lib-src/pango-1.28.3/COPYING share/doc/pango-dev-1.28.3
...
zip -r $ZIP share/doc/pango-1.28.3
...
zip -r $DEVZIP share/doc/pango-dev-1.28.3
